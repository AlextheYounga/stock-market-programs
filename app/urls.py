...
urlpatterns = [
    ...
    path('inflation', views.inflation, name='inflation.index'),
    path('inflation/<str:ticker>/', views.inflation, name='inflation.show'),
    path('rescaledrange', views.rescaledrange, name='rescaledrange.index'),
    path('rescaledrange/<str:ticker>/', views.rescaledrange, name='rescaledrange.show'),
