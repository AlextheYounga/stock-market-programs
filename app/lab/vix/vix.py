...
class Vix:
    def __init__(self, sendtweet=False, debug=False, dummyData=False, saveResults=False):
    ...
    def equation(self, ticker):
        ...
        chain = collectOptionChain(ticker, self.dummyData)
